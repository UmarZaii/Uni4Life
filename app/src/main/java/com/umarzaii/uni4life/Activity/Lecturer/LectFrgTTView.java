...
public class LectFrgTTView extends Fragment implements View.OnClickListener {
    ...
    private Button btnGoToTTEdit, btnTTDismiss;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.dptad_frg_ttview,container,false);
        return view;
    }
    ...
    private void initClass() {
        ...
        btnGoToTTEdit = (Button)v.findViewById(R.id.btnGoToTTEdit);
        btnTTDismiss = (Button)v.findViewById(R.id.btnTTDismiss);
        ...
        btnGoToTTEdit.setOnClickListener(this);
        btnTTDismiss.setOnClickListener(this);
    }

    @Override
    public void onClick(View v) {
        switch(v.getId()){
            case R.id.btnGoToTTEdit:
                goToTTEdit();
                break;
            case R.id.btnTTDismiss:
                dismissClass();
                break;
            default:
    ...
    private void dismissClass() {
        ...
        ttModel.setSubjectID("");
        ttModel.setLecturerID("");
        ttModel.setUserClassID("");
    ...
    private void goToTTEdit() {
        ...
        frgController.stackFragment(new LectFrgTTEdit(), R.id.lectContentMain, bundle, "TTEdit");
    }
}