...
import com.umarzaii.uni4life.Activity.DeptAdmin.DptAdmFrgTTView;
...
public class LectFrgTTList extends Fragment {
    ...
    public void onClickEvent(String dayID, String timeID) {
        ...
        if(getArguments().getString("status") == "MyTimeTable") {
            ...
            frgController.stackFragment(new LectFrgTTView(), R.id.lectContentMain, bundle, "TTView");
